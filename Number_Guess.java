/*
Oasis Infobyte Java development internship Feb23 Batch 
Name --> Gandhar Sudhir Hardikar
Task 2 --> NUMBER GUESSING GAME
*/

import java.util.*;
public class Number_Guess  //Class created
{
    static ArrayList<Integer> score = new ArrayList<Integer>(); //Array list
    public static void main(String[] args) //Main method
    {
    	Number_Guess method = new Number_Guess();
        method.menu(score);
    }
    public void menu(ArrayList<Integer> scoreBoard) //Method created for menu of number guessing game
    {
    	Number_Guess method = new Number_Guess();  //Constructor
